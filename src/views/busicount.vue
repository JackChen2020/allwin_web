<template>
    <section >
        ...
        <el-table
            ...
            <el-table-column prop="id" label="用户ID" width="120" sortable align="center">
            </el-table-column>
            <el-table-column prop="typeid" label="支付方式ID" width="120" sortable align="center">
            </el-table-column>
...
<script>
    import { busi_count  } from '~/api/request/request';
