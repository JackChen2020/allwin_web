    ...
    <div>
        <el-row :span="24">
            <el-col :md="7"
                ...
                <basic-container>
                    <div class="info">
                        <el-link class="img-border1" type="success"  target="_blank">商户ID: {{user.userid}}</el-link>
                    </div>
                </basic-container>
                <basic-container>
                    <div class="info">
                        <el-link class="img-border" type="success" href="https://www.showdoc.cc/352507980905292" target="_blank">api文档接入</el-link>
                    </div>
                </basic-container>
                <basic-container>
                    <div class="info">
